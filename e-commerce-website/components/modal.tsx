...
function Modal({children, headingText, handleFunction, hasLink, hasHandler} : {children:React.ReactNode, headingText:string, handleFunction?: () => void, hasLink?: boolean, hasHandler?:boolean}) {
    ...
    return (
        <>
        <div className="absolute top-1/2 left-1/2 -translate-1/2 w-full min-h-screen bg-modal-background overflow-hidden">
            <div className="absolute top-1/2 left-1/2 rounded-md -translate-x-1/2 -translate-y-1/2 overflow-y-auto h-11/12 bg-[#f9f9f9] shadow-custom p-3 w-full md:w-[700px]">
                <div>

            ...
            <form action={updateFormAction} className='custom-form-styles'>
                <div className='input-container'>
                    ...
                    <div className='input-container col-span-2 self-center'>
                        ...
                        <select name="role" defaultValue={(state?.payload?.get("role") as string) ? state?.payload?.get("role") as string : userData.role} className='px-2 py-1 border border-gray-300 rounded-lg bg-white text-gray-700 focus:outline-none focus:ring-2 focus:ring-primary focus:outline-primary duration-300' id="role">
